...
- **Cross-pool transfers**: every active pool to every other active pool at each NU
...
- **Per-phase manifests** documenting every TXID, mined height, value, fee, and address
